...
public class Reglas extends JFrame {
    ...
    public static JFrame frameReglas;
    ...
    public Reglas() {
      ...
      frameReglas = new JFrame(); // Modificación aquí
      frameReglas.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      frameReglas.setSize(screen1.height, screen1.width);
      frameReglas.setResizable(true);
   ...
   // Bloque 1
      ...
      frameReglas.add(scrollPane);
       
      frameReglas.setLocationRelativeTo(null); // Modificación aquí
      frameReglas.setVisible(false); // Modificación aquí
    }
}